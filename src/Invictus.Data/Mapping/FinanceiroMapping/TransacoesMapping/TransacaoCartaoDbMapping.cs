...
{
    public class TransacaoCartaoDbMapping : IEntityTypeConfiguration<TransacaoCartaoAggregate>
    {
        public void Configure(EntityTypeBuilder<TransacaoCartaoAggregate> builder)
        {
            ...
            builder.ToTable("TransacaoCartao");
        }
    }
}
